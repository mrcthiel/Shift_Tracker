...
CTPPSFastRecHits = cms.EDProducer('CTPPSRecHitProducer',
	...
	ShiftArmBTrack1X = cms.double(0.0),#in mm
        ShiftArmBTrack1Y = cms.double(0.0),#in mm
        ShiftArmBTrack2X = cms.double(0.0),#in mm
        ShiftArmBTrack2Y = cms.double(0.0),#in mm
        ShiftArmFTrack1X = cms.double(0.0),#in mm
        ShiftArmFTrack1Y = cms.double(0.0),#in mm
        ShiftArmFTrack2X = cms.double(0.0),#in mm
        ShiftArmFTrack2Y = cms.double(0.0)#in mm
